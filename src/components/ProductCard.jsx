...
const ProductCard = (item) => {
	...
	return (
		<div className="product-card">
			<div onClick={() => showDetailsPage(product.id)}>
				...
				<div className="card-bottom d-flex flex-column justify-content-center align-items-center">
					...
					<div className='actions-card'>
						...
						<button onClick={() => showDetailsPage(product.id)} className='btn btn-primary m-2'>Know More</button>
						<button className='btn btn-danger m-2'>Delete Listing</button>
					</div>
				</div>
			</div>
		</div>
