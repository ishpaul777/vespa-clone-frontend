	...
	return (
		<div className='d-flex h-100 justify-content-center align-items-center'>
			...
			<div className='product-details'>
				...
				<p>
					<i>
						<strong className='product-price'>₹{product.price} Ex-showroom price</strong> <br />
						EMI starting from ₹{financers[0].monthly_emi} / month
				...
				<Link to='/' className='text-decoration-none btn btn-pill d-block'
					style={{
						float: 'left',
						position: 'absolute',
						bottom: '2rem',
